...
const games = [
  {
    title: 'Spider-Man 2',
    description: 'The next installment in the Spider-Man franchise, where players control both Peter Parker and Miles Morales...',
    image: 'https://image.api.playstation.com/vulcan/ap/rnd/202306/1301/0357d5697ac91c4a9a6493eb0d02654006e417b4e0dbb351.png',
    releaseYear: 2023,
    rating: 9.4,
  ...
  },
  {
    ...
    description: 'A next-gen remake of the classic survival horror game, with enhanced visuals, sound, and gameplay mechanics...',
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQktT8a8cUnF-z6_pEynuRlGhNYtNnuU71H1A&s',
    releaseYear: 2023,
    rating: 9.3,
  ...
  },
  {
    ...
    description: 'A major expansion to Cyberpunk 2077, introducing a new storyline, location, and characters while improving the base game’s mechanics.',
    image: 'https://shared.cloudflare.steamstatic.com/store_item_assets/steam/apps/2138330/capsule_616x353.jpg?t=1730212614',
    releaseYear: 2023,
    rating: 8.7,
    platforms: ['PlayStation 5', 'Xbox Series X/S', 'PC']
  },
  {
    ...
    description: 'A sequel to Star Wars Jedi: Fallen Order, continuing the story of Cal Kestis as he battles the Empire and uncovers new secrets of the Force.',
    image: 'https://image.api.playstation.com/vulcan/ap/rnd/202304/2814/24a5bc14faa8f69c74a9a8d7b729509841a1c9046bc9a7f3.png?w=440',
    releaseYear: 2023,
    rating: 9.0,
    platforms: ['PlayStation 5', 'Xbox Series X/S', 'PC']
  },
  ...
  },
  {
    ...
    description: 'A new expansion for Resident Evil Village, following Ethan’s daughter, Rosemary, as she explores the dark corners of the story’s world.',
    image: 'https://assets-prd.ignimgs.com/2022/06/14/resident-evil-village-shadows-of-rose-dlc-button-1-1655250123777.jpg',
    releaseYear: 2023,
    rating: 8.9,
    platforms: ['PlayStation 5', 'Xbox Series X/S', 'PC']
  },
  {
    title: 'Diablo IV',
    description: 'The highly anticipated fourth entry in the Diablo series, where players explore the dark and gothic world of Sanctuary, battling against the forces of Hell and the demoness, Lilith.',
  ...
  },
  {
    ...
    description: 'An upcoming action role-playing game based on the classic Chinese novel Journey to the West. You play as the legendary Monkey King, Sun Wukong, using his powers to battle mythical creatures.',
  ...
  },
  {
    ...
    description: 'A tactical third-person shooter set in a post-apocalyptic Washington D.C. where players work as Division agents to restore order.',
  ...
  },
  {
    ...
    description: 'A return to the franchise’s roots, this stealth action game follows Basim Ibn Ishaq in the city of Baghdad during the Islamic Golden Age.',
    image: 'https://staticctf.ubisoft.com/J3yJr34U2pZ2Ieem48Dwy9uqj5PNUQTn/4jk9umchC6RomrmUMzJj4k/ae72f547328f84428d4b98a663bceec6/acm-page-meta-960x540.jpg',
    releaseYear: 2023,
    rating: 8.5,
    platforms: ['PlayStation 5', 'Xbox Series X/S', 'PC']
  }
    ...
    <div className="home-page">
      ...
      <section className="relative w-full h-[500px]">
        ...
        <div className="absolute inset-0 bg-black opacity-50 flex justify-center items-center text-white">
          <h1 className="text-4xl font-bold sm:text-5xl md:text-6xl hover:text-blue-400 transition duration-300">Welcome to the World of Games</h1>
        </div>
      </section>
            ...
            {games.map((game, index) => (
              <div key={index} className="bg-gray-800 p-6 rounded-lg shadow-lg overflow-hidden">
                ...
                <div className="mt-4 text-gray-300">
                  ...
                  <p><strong>Rating:</strong> {game.rating ? game.rating : 'Not Rated'}</p>
      ...
      <section className="py-12 bg-gray-900 text-white text-center">
        <div className="container mx-auto">
          ...
          <p className="text-lg sm:text-xl md:text-2xl mb-6">
            Stay up-to-date with the latest news, game releases, and exciting updates across all genres of gaming!
          </p>
          <a
            href="/subscribe"
